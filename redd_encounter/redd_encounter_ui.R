...
redd_encounter_ui = tags$div(
  ...
  tippy("<i style='color:#1a5e86;padding-left:8px', class='fas fa-info-circle'></i>",
        tooltip = glue("To enable tracking redds over time, please enter the redd ",
                       "location data first. Then to associate any new redd data to ",
                       "the location, first select the row with the location data,",
                       "then enter the redd count here. If redds are not being tracked, ",
                       "make sure to unselect any redd location data above.")),
  br(),
  br(),
