...
survey_content = tags$div(
  ...
  selectizeInput(inputId = "upper_rm_select", label = "up_rm", choices = NULL, width = "75px"),
  selectizeInput(inputId = "lower_rm_select", label = "lo_rm", choices = NULL, width = "75px"),
