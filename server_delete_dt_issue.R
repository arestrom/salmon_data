...
server = function(input, output, session) {
  ...
  output$surveys = renderDT({
    year_select = paste0(input$year_select, collapse = "; ")
    survey_title = glue("Surveys for {input$stream_select} in {year_select}")
    survey_data = dtf_surveys()
    # Generate table
  ...
  #   removeModal()
  #   replaceData(survey_dt_proxy, dtf_surveys())
  # })
  ...
  #   removeModal()
  #   reloadData(survey_dt_proxy, dtf_surveys())
  # })
