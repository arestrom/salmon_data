...
redd_location_ui = tags$div(
  ...
  tippy("<i style='color:#1a5e86;padding-left:8px', class='fas fa-info-circle'></i>",
        tooltip = glue("For new redd data, please first enter the redd name (flag code) ",
                       "and any other location data here. Then enter the count data ",
                       "below after selecting the corresponding row of location data. ",
