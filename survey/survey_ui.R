...
survey_ui = tags$div(
  ...
  tippy("<i style='color:#1a5e86;padding-left:8px', class='fas fa-info-circle'></i>",
        tooltip = glue("Shaded input fields in this, and all other data entry screens ",
                       "below, indicate required fields. If a survey was not ",
                       "completed, please also indicate why the survey was not completed ")),
  br(),
  br(),
